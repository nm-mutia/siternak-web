...
class MatchController extends Controller
{
    ...
    public function match(Request $request)
    {
		...
		$j_parent = DB::select('SELECT public."search_parent"(?,?)', [$sp[6], $sp[7]]);
        ...
        $j_sibling = DB::select('SELECT public."search_sibling"(?,?,?)', [$sp[1], $sp[6], $sp[7]]);
        ...
        $j_gparent = DB::select('SELECT public."search_gparent"(?,?)', [$sp[6], $sp[7]]);
